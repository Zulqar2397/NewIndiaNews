...
public class NewsDto {
    ...
    public NewsDto(long newsId, String title, String description, String region, String source, long likeCount, Date date, Time time, long hitCount, AdminsDto admins, List<ImageDto> images, List<CommentDto> comments, CategoryDto category) {
        this.newsId = newsId;
        this.title = title;
